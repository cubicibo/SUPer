...
if __name__ == '__main__':
    ...
    parser.add_argument('--redraw-period', help="Add redraws every N integer seconds [0: Disabled] - also known as 'acquisition point interval'. (def:  %(default)s)", type=int, default=0, required=False)
    ...
    parameters |= {
        ...
        'refresh_period': args.redraw_period,
